...
public class RecordingCommonConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> AUDIO_SAVING_COOLDOWN;
    public static final ForgeConfigSpec.ConfigValue<Integer> CACHE_REMOVAL_TIME;
    public static final ForgeConfigSpec.ConfigValue<Integer> CACHE_CHECK_INTERVAL;
    static {
        ...
        AUDIO_SAVING_COOLDOWN = BUILDER.comment("Amount of ticks to wait after an audio is saved to write it to disk")
                .define("Audio Saving Cooldown", 5 * 60 * 20);
        ...
        CACHE_CHECK_INTERVAL = BUILDER.comment("How long, in seconds, the cache will wait between checking cached audios to remove old ones.")
                .define("Cache Check Interval", 60);
